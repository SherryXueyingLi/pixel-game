...
For those who cannot access to youtobe, check the answer [here](https://leetcode.com/discuss/26310/detail-explain-about-morris-traversal-finds-incorrect-pointer);
            `,subject:`Two elements of a binary search tree (BST) are swapped by mistake.\n
...
A solution using O(n) space is pretty straight forward. Could you devise a constant space solution?\n`
    ...
    render(){
        ...
        return <Template code={code} explain={explain} title={RecoverTree.title()} id={this.props.id} difficulty="Hard" subject={subject} difficulty="Hard"/>
    }
}