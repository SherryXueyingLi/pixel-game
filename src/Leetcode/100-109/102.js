...
var travel = function(root, level, rt) {
    ...
    if(root.right) travel(root.right, level+1, rt);
            ...
            explain:`
            `,subject:`Given a binary tree, return the level order traversal of its nodes' values. (ie, from left to right, level by level).
...
return its level order traversal as:\n
    ...
    render(){
        ...
        return <Template code={code} explain={explain} title={BSTLevelOrder.title()} id={this.props.id} difficulty="Easy" subject={subject}/>
    }
}